...
#define UE_PROJECT_NAME ShooterGameCourse
#define UE_TARGET_NAME ShooterGameCourseEditor
#define UE_MODULE_NAME "ShooterGameCourse"
...
#define SHOOTERGAMECOURSE_API DLLEXPORT
